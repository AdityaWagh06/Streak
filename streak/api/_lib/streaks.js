/**
 * Helper to get YYYY-MM-DD string for a Date in local timezone or UTC
 */
...
export function calculateStreaks(allLogs = {}, habits = [], referenceDateStr = null) {
  ...
  // If today has activity, walk back from today; otherwise if yesterday has activity, walk back from yesterday
  ...
  // 2. Overall Longest Streak & Per-Habit Longest Streak
